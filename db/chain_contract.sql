...
DROP TABLE IF EXISTS `month_retail`;
CREATE TABLE `month_retail` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `schedule_year` int(50) DEFAULT NULL COMMENT '年',
  `schedule_month` int(50) DEFAULT NULL COMMENT '月',
	`product_line_id` int(50) DEFAULT NULL COMMENT '',
  `product_line_code` varchar(20) DEFAULT NULL COMMENT '产品组编码',
  `product_line_name` varchar(200) DEFAULT NULL COMMENT '产品组名称',
	`trade_id` int(50) DEFAULT NULL COMMENT '',
  `trade_code` varchar(20) DEFAULT '' COMMENT '中心编码',
  `trade_name` varchar(200) DEFAULT NULL COMMENT '中心名称',
  `sale_chan_code` varchar(80) DEFAULT NULL COMMENT '',
  `sale_chan_name` varchar(200) DEFAULT NULL COMMENT '',
  `pro_band` varchar(80) DEFAULT NULL COMMENT '品牌编码',
  `pro_band_name` varchar(200) DEFAULT NULL COMMENT '品牌名称',
  `smb_code` varchar(300) DEFAULT NULL COMMENT '型号编码',
  `smb_name` varchar(300) DEFAULT NULL COMMENT '型号名称',
  `product_code` varchar(50) DEFAULT NULL COMMENT '',
  `product_sname` varchar(200) DEFAULT NULL COMMENT '',
  `first_region_code` varchar(80) DEFAULT NULL COMMENT '网格小微编码',
  `first_region_name` varchar(200) DEFAULT NULL COMMENT '网格小微名称',
	`customer_id` int(50) DEFAULT NULL COMMENT '',
  `customer_code` varchar(50) DEFAULT NULL COMMENT '',
  `customer_name` varchar(200) DEFAULT NULL COMMENT '',
  `sales_amount` varchar(255) DEFAULT NULL COMMENT '抢单数量金额（万元）',
  `remark01` varchar(255) DEFAULT NULL COMMENT '备用字段1',
  `remark02` varchar(255) DEFAULT NULL COMMENT '备用字段2',
  `remark03` varchar(255) DEFAULT '' COMMENT '备用字段3',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
