...
CREATE TABLE `month_retail` (
  ...
  `pro_band_code` varchar(80) DEFAULT NULL COMMENT '品牌编码',
  ...
  `rcm_station_code` varchar(80) DEFAULT NULL COMMENT '网格小微编码',
  `rcm_station_name` varchar(200) DEFAULT NULL COMMENT '网格小微名称',
  `customer_code` varchar(50) DEFAULT NULL COMMENT '',
  `customer_name` varchar(200) DEFAULT NULL COMMENT '',
  `outlet_code` varchar(80) DEFAULT NULL COMMENT '',
  `outlet_name` varchar(200) DEFAULT NULL COMMENT '',
   `sub_emp_code` varchar(80) DEFAULT NULL COMMENT '',
  `sub_emp_name` varchar(200) DEFAULT NULL COMMENT '',
  `qty` int(11) DEFAULT NULL COMMENT '抢单数量',
  `price` varchar(255) DEFAULT NULL COMMENT '抢单数量金额（万元）',
  `retail_amt` varchar(255) DEFAULT NULL COMMENT '抢单数量金额（万元）',
  `mkt_lookup_code` char(1) DEFAULT NULL COMMENT '',
