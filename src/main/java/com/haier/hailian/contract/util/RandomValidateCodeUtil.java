...
public class RandomValidateCodeUtil {
     ...
     */
    private static String Num_Random = "0123456789";
    //随机产生只有字母的字符串
    ...
    public void getRandcode(HttpServletRequest request, HttpServletResponse response) {
        ...
        log.info("RandomValidateCodeUtil generate code is {}",randomString);
    ...
    public static String getRandomString(int num) {
        return String.valueOf(Num_Random.charAt(num));
    }
     ...
     * @return
     */
    public static String buildNumberRandomCode(int size) {
        StringBuffer sb = new StringBuffer();
         Random temRandom = new Random();
        for (int i = 0; i < size; i++) {
            String rand = String.valueOf(getRandomString(temRandom.nextInt(Num_Random
                    .length())));
            sb.append(rand);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(randomValidateCodeUtil.buildNumberRandomCode(6));
    }
}
